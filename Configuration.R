...
if (Project == 'TI3GER') {
  ...
  VRPlot$PV3 <- c('ATH1', 'ATH2', 'AT_A', 'ATF1', 'AT_A2') # Cory and Stuart say not relevant , 'AT_VXL')
  VRPlot$PV4 <- c('ATH1', 'ATH2', 'AT_A', 'ATF1', 'AT_A2') # Cory and Stuart say not relevant, 'AT_VXL')
