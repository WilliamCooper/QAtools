...
if (Project == 'ASPIRE') {
  ...
  VRPlot$PV3 <- c('ATH1', 'ATH2', 'ATH3', 'ATH4', 'AT_A', 'AT_A2')
  VRPlot$PV4 <- c('ATH1', 'ATH2', 'ATH3', 'ATH4', 'AT_A', 'AT_A2')
  ...
  VRPlot$PV6 <- c('PSFC', 'PS_A', 'PSF', 'PSFF', 'PSFFC', 'PSTF', 'PSX', 'PS_A2', 'PSTFC')
  ...
  VRPlot$PV9 <- c('WDC', 'IWD', 'WSC', 'IWS', 'WIC', 'ADIFR', 'WD', 'WS', 'WIY', 'IWD_IRS2', 'IWD_IRS3', 'IWS_IRS2', 'IWS_IRS3')
