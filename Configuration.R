...
if (Project == 'SPICULE') {
  ...
  VRPlot$PV14 <- c('')
  VRPlot$PV15 <- c('CONCN', 'CONCU100_LWII', 'CONCU500_LWII', 'CONCU_LWII', 'USHFLW_LWII', 'USMPFLW_LWII', 'UREF_LWII', 'CONCD_LWOI', 'CONC1DC_RWOO', 'USCAT_LWII', 'UBTMP_LWII', 'UTEMP_LWII', 'UFLWC_LWII')
  VRPlot$PV16 <- c('PLWCC', 'PLWC', 'RICE', 'DBARU_LWII', 'DBARD_LWOI', 'PLWCD_LWOI', 'TCNTD_LWOI', 'REJDOF_LWOI', 'AVGTRNS_LWOI', 'CDPLSRP_LWOI', 'CDPCBTMP_LWOI', 'CDPLBTMP_LWOI', 'CDPWBTMP_LWOI', 'CDPLSRC_LWOI', 'DBAR1DC_RWOO', 'PLWC1DC_RWOO')
  ...
  VRPlot$PV21 <- c('TASX', 'CUHSAS_LWII', 'CONCU_LWII')
  VRPlot$PV22 <- c('TASX', 'CONC1DC_RWOO', 'C1DC_RWOO')
  VRPlot$PV23 <- c('TASX', 'CAVP_WVISO2346', 'd18O_WVISO2346', 'dD_WVISO2346', 'H2O_WVISO2346', 'TEMP_WVISO2346')
