...
if (Project == 'SPICULE') {
  ...
  VRPlot$PV13 <- c('ACINS', 'ACINS_IRS3', 'VSPD', 'VSPD_A', 'GGALT', 'ALT_A', 'ACINS_IRS2', 'GGVSPD', 'GGVSPD_232', 'VSPD_A2', 'VSPD_IRS2', 'VSPD_IRS3', 'ALT', 'ALT_A2', 'ALT_IRS2', 'ALT_IRS3', 'GEOPTH', 'GEOPTH_232', 'GGALT_232', 'ACINS_IE', 'GGVSPD_VTB', 'GGVSPD_VTB2', 'VSPD_AE', 'VSPD_IE', 'ALT_AE', 'ALT_IE', 'GGALT_VTB', 'GGALT_VTB2')
  VRPlot$PV14 <- c('')
