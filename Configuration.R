...
if (Project == 'TI3GER') {
  ...
  VRPlot$PV6 <- c('PSFC', 'PS_A', 'PSF', 'PSFF', 'PSFFC', 'PSTF', 'PSX', 'PS_A2', 'PS_VXL', 'PSTFC', 'PS_LWO')
  ...
  VRPlot$PV14 <- c('')
  VRPlot$PV15 <- c('CONCU_FBTM', 'CONCU100_FBTM', 'CONCU500_FBTM', 'CONCD_RWOO', 'USHFLW_FBTM', 'USMPFLW_FBTM', 'UREF_FBTM', 'USCAT_FBTM', 'UBTMP_FBTM', 'ULSRTEMP_FBTM', 'UFLW_FBTM', 'UFLWC_FBTM', 'UPRGFLW_FBTM')
  VRPlot$PV16 <- c('PLWCC', 'PLWC', 'RICE', 'DBARD_RWOO', 'DBARU_FBTM', 'PLWCD_RWOO', 'TCNTD_RWOO', 'REJDOF_RWOO', 'AVGTRNS_RWOO', 'CDPLSRP_RWOO', 'DBARS_2DS', 'CDPCBTMP_RWOO', 'CDPLBTMP_RWOO', 'CDPWBTMP_RWOO', 'CDPLSRC_RWOO')
  ...
  VRPlot$PV20 <- c('TASX', 'CCDP_RWOO', 'CONCD_RWOO')
  ...
  VRPlot$PV26 <- c('TASX', 'ATX', 'GGALT', 'CONCD_RWOO')
