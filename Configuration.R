...
if (Project == 'TI3GER') {
  ...
  VRPlot$PV16 <- c('PLWCC', 'PLWC', 'RICE', 'DBARD_LWOO', 'DBARU_FBTM', 'PLWCD_LWOO', 'TCNTD_LWOO', 'REJDOF_LWOO', 'AVGTRNS_LWOO', 'CDPLSRP_LWOO', 'CDPCBTMP_LWOO', 'CDPLBTMP_LWOO', 'CDPWBTMP_LWOO', 'CDPLSRC_LWOO')
