...
if (Project == 'MethaneAIR') {
  ...
  VRPlot$PV3 <- c('ATH1', 'ATH2', 'AT_A', 'ATF1', 'AT_A2', 'AT_AE')
  VRPlot$PV4 <- c('ATH1', 'ATH2', 'AT_A', 'ATF1', 'AT_A2', 'AT_AE')
  ...
  VRPlot$PV13 <- c('ACINS', 'ACINS_IRS3', 'VSPD', 'VSPD_A', 'GGALT', 'ALT_A', 'ACINS_IRS2', 'GGVSPD', 'VSPD_A2', 'VSPD_IRS2', 'VSPD_IRS3', 'ALT', 'ALT_A2', 'ALT_IRS2', 'ALT_IRS3', 'GEOPTH', 'ACINS_IE', 'GGVSPD_UDP', 'VSPD_AE', 'VSPD_IE', 'ALT_AE', 'ALT_IE', 'GGALT_UDP')
  VRPlot$PV14 <- c('')
  VRPlot$PV15 <- c('')
  VRPlot$PV16 <- c('RICE')
