...
if (Project == 'SPICULE') {
  ...
  VRPlot$PV6 <- c('PSFC', 'PS_A', 'PSF', 'PSFF', 'PSTF', 'PSX', 'PS_A2', 'PS_AE', 'PS_VXL')
  ...
  VRPlot$PV16 <- c('PLWCC', 'PLWC', 'RICE', 'DBARU_LWII', 'DBARD_LWOI', 'DBAR1DC_RWOO', 'PLWCD_LWOI', 'PLWC1DC_RWOO', 'TCNTD_LWOI', 'REJDOF_LWOI', 'AVGTRNS_LWOI', 'CDPLSRP_LWOI', 'CDPCBTMP_LWOI', 'CDPLBTMP_LWOI', 'CDPWBTMP_LWOI', 'CDPLSRC_LWOI')
  ...
  VRPlot$PV23 <- c('TASX', 'CAVP_PIC2130', 'DH_PIC2130', 'H20_PIC2130', 'TEMP_PIC2130') # omitting '1816_PIC2130'
