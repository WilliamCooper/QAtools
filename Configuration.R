...
if (Project == 'TI3GER') {
  ...
  VRPlot$PV2 <- c('LATC', 'LONC', 'WDC', 'WSC', 'GGALT', 'PALT', 'PSXC', 'GGNSAT')
  VRPlot$PV3 <- c('ATH1', 'ATH2', 'AT_A', 'ATF1', 'AT_A2')  ## omitted AT_VXL
  VRPlot$PV4 <- c('ATH1', 'ATH2', 'AT_A', 'ATF1', 'AT_A2')  ## omitted AT_VXL
  VRPlot$PV5 <- c('DP_DPR', 'DP_DPL', 'DP_VXL', 'ATX', 'CAVP_DPL', 'CAVP_DPR', 'PSXC', 'QCFC', 'EW_DPL', 'EW_DPR', 'MR', 'EW_VXL', 'QCXC', 
                  'AKRD', 'MACHX', 'CAVP_DPL', 'CAVP_DPR', 'PSXC', 'QCXC', 'MACHX', 'AKRD', 'MR', 'SMPLSRINT_VXL')
  ...
  VRPlot$PV14 <- c('')
  VRPlot$PV15 <- c('CONCU_FBTM', 'CONCU100_FBTM', 'CONCU500_FBTM', 'CONCD_LWOO', 'CONCS_2DS', 'USHFLW_FBTM', 'USMPFLW_FBTM', 'UREF_FBTM', 'USCAT_FBTM', 'UBTMP_FBTM', 'ULSRTEMP_FBTM', 'UFLW_FBTM', 'UFLWC_FBTM', 'UPRGFLW_FBTM')
  VRPlot$PV16 <- c('PLWCC', 'PLWC', 'RICE', 'DBARD_LWOO', 'DBARU_FBTM', 'PLWCD_LWOO', 'TCNTD_LWOO', 'REJDOF_LWOO', 'AVGTRNS_LWOO', 'CDPLSRP_LWOO', 'DBARS_2DS', 'CDPCBTMP_LWOO', 'CDPLBTMP_LWOO', 'CDPWBTMP_LWOO', 'CDPLSRC_LWOO')
  ...
  VRPlot$PV21 <- c('TASX', 'CUHSAS_FBTM', 'CONCU_FBTM')
  VRPlot$PV22 <- c('TASX')
  VRPlot$PV23 <- c('FO3_ACD', 'TASX', 'CO_PIC2401', 'COCAL_PIC2401', 'COCOR_PIC2401', 'COZRO_PIC2401', 'CH4_PIC2401', 'CH4C_PIC2401', 'CO2_PIC2401', 'CO2C_PIC2401', 'H2O_PIC2401', 'CO_ARI', 'COA_ARI', 'COCAL_ARI', 'COCOR_ARI', 'COZRO_ARI', 'H2O_ARI', 'N2O_ARI', 'N2OA_ARI', 'P_ARI', 'T_ARI')
...
if (Project == 'MethaneAIR21') {
  ...
  VRPlot$PV3 <- c('ATH1', 'ATH2', 'AT_A', 'AT_A2')
  VRPlot$PV4 <- c('ATH1', 'ATH2', 'AT_A', 'AT_A2')
  ...
  VRPlot$PV21 <- c('TASX')
  VRPlot$PV22 <- c('TASX')
  VRPlot$PV23 <- c('TASX', 'CO_PIC2401', 'COCAL_PIC2401', 'COCOR_PIC2401', 'COZRO_PIC2401', 'CH4_PIC2401', 'CH4C_PIC2401', 'CO2_PIC2401', 'CO2C_PIC2401', 'H2O_PIC2401', 'CO_ARI108', 'COA_ARI108', 'COCAL_ARI108', 'COCOR_ARI108', 'COZRO_ARI108', 'H2O_ARI108', 'N2O_ARI108', 'N2OA_ARI108', 'P_ARI108', 'T_ARI108')
  VRPlot$PV24 <- c('ATX', 'TASX')
  VRPlot$PV25 <- c('ATX', 'TASX')
