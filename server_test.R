...
server <- function(input, output, session) {
  ...
  output$S1E1Plot <- renderPlot ({
    ...
    load ('/srv/shiny-server/RSessions/RSessions/Session1/Data.Rdata')
  ...
  output$S1E2Plot <- renderPlot ({
    ...
    saveDataFile <- '/srv/shiny-server/RSessions/RSessions/Session1/Data2.RData'
  ...
  output$S1Stats <- renderDataTable ({
    ...
    save (Ds, file='/srv/shiny-server/RSessions/RSessions/Session1/Data3.Rdata')
    load ('/srv/shiny-server/RSessions/RSessions/Session1/Data3.Rdata')
    Dstats['Time', 1] <- 'Time'
    Dstats['Time', 2] <- NA
    Dstats['Time', 3] <- NA
  ...
  output$txtS2c1 <- renderUI({
    ...
    load('/srv/shiny-server/RSessions/RSessions/Session2/DataS2b.Rdata')
    load('/srv/shiny-server/RSessions/RSessions/Session2/txw.Rdata')
    blkline <- '                           '
  ...
  observeEvent (input$XS2a, {
    showModal(modalDialog(
      includeHTML('/srv/shiny-server/RSessions/RSessions/Session2/Session2c3.html'),
  ...
  output$RS3apng <- renderImage ({
    list(src = sprintf('/srv/shiny-server/RSessions/RSessions/Session3/S%02d.png', input$S3aframe),
      contentType = 'image/png',
      width = 800,
      height = 600,
  ...
  output$RS3bpng <- renderImage ({
    list(src = sprintf('/srv/shiny-server/RSessions/RSessions/Session3/S%02d.png', input$S3bframe),
      contentType = 'image/png',
      width = 800,
      height = 600,
      alt = "RSessions image goes here")
  ...
  output$RS3cpng <- renderImage ({
    list(src = sprintf('/srv/shiny-server/RSessions/RSessions/Session3/S%02d.png', input$S3cframe),
      contentType = 'image/png',
      width = 800,
      height = 600,
      alt = "RSessions image goes here")
  ...
  output$RS3dpng <- renderImage ({
    list(src = sprintf('/srv/shiny-server/RSessions/RSessions/Session3/S%02d.png', input$S3dframe),
      contentType = 'image/png',
      width = 800,
      height = 600,
      alt = "RSessions image goes here")
  ...
  output$RS4png <- renderImage ({
    list(src = sprintf('/srv/shiny-server/RSessions/RSessions/Session4/S%02d.png', input$S4frame),
      contentType = 'image/png',
      width = 800,
      height = 600,
      alt = "RSessions image goes here")
  ...
  output$RS5png <- renderImage ({
    list(src = sprintf('/srv/shiny-server/RSessions/RSessions/Session5/S%02d.png', input$S5frame),
      contentType = 'image/png',
      width = 800,
      height = 600,
      alt = "RSessions image goes here")
  ...
  output$RS5apng <- renderImage ({
    list(src = sprintf('/srv/shiny-server/RSessions/RSessions/Session5/S%02d.png', input$S5aframe),
      contentType = 'image/png',
      width = 800,
      height = 600,
      alt = "RSessions image goes here")
  ...
  output$RS5bpng <- renderImage ({
    list(src = sprintf('/srv/shiny-server/RSessions/RSessions/Session5/S%02d.png', input$S5bframe),
      contentType = 'image/png',
      width = 800,
      height = 600,
      alt = "RSessions image goes here")
  ...
  output$RS5cpng <- renderImage ({
    list(src = sprintf('/srv/shiny-server/RSessions/RSessions/Session5/S%02d.png', input$S5cframe),
      contentType = 'image/png',
      width = 800,
      height = 600,
      alt = "RSessions image goes here")
  ...
  output$RS6png <- renderImage ({
    list(src = sprintf('/srv/shiny-server/RSessions/RSessions/Session6/S%02d.png', input$S6frame),
      contentType = 'image/png',
      width = 800,
      height = 600,
      alt = "RSessions image goes here")
  ...
  output$RS7png <- renderImage ({
    list(src = sprintf('/srv/shiny-server/RSessions/RSessions/Session7/S%02d.png', input$S7frame),
      contentType = 'image/png',
      width = 800,
      height = 600,
      alt = "RSessions image goes here")
  ...
  output$RS8png <- renderImage ({
    list(src = sprintf('/srv/shiny-server/RSessions/RSessions/Session8/S%02d.png', input$S8frame),
      contentType = 'image/png',
      width = 800,
      height = 600,
      alt = "RSessions image goes here")
  ...
  output$RS9png <- renderImage ({
    list(src = sprintf('/srv/shiny-server/RSessions/RSessions/Session9/S%02d.png', input$S9frame),
      contentType = 'image/png',
      width = 800,
      height = 600,
      alt = "RSessions image goes here")
