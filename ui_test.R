    ...
    tabPanel ('Background',
      ...
      tabsetPanel (id='whichBg', type='pills',
        ...
        tabPanel ('R sessions (tutorial)',
          tabsetPanel (id='whichTab', type='pills',
            tabPanel ('TOC',
              includeHTML('/srv/shiny-server/RSessions/RSessions/TOC/TOC.html')),
            tabPanel ('Getting Started',
              tabsetPanel (id='S1tab', type='pills',
                tabPanel ('Getting Started',
                  includeHTML('/srv/shiny-server/RSessions/RSessions/Session1/Session1a.html')),
                tabPanel ('RStudio Tour',
                  includeHTML('/srv/shiny-server/RSessions/RSessions/Session1/Session1b.html')),
                tabPanel ('Some Examples',
                  includeHTML('/srv/shiny-server/RSessions/RSessions/Session1/Session1c.html'),
                  tabsetPanel (id='S1ex', type='pills',
                    tabPanel ('simple plot',
                      includeHTML ('/srv/shiny-server/RSessions/RSessions/Session1/E1Code.html'),
                      sidebarLayout(
                        sidebarPanel(
                    ...
                    tabPanel ('sounding',
                      includeHTML ('/srv/shiny-server/RSessions/RSessions/Session1/E2Code.html'),
                      plotOutput ('S1E2Plot', width="50%")),
                    tabPanel ('stats',
                      includeHTML ('/srv/shiny-server/RSessions/RSessions/Session1/E3Code.html'),
                      dataTableOutput ('S1Stats')),
                    tabPanel ('recovery factor',
                      includeHTML ('/srv/shiny-server/RSessions/RSessions/Session1/E4Code.html'))
                  )
                ),
                tabPanel ('Text-with-Code',
                  includeHTML ('/srv/shiny-server/RSessions/RSessions/Session1/Session1d.html')),
                tabPanel ('Getting Ranadu',
                  includeHTML ('/srv/shiny-server/RSessions/RSessions/Session1/Session1e.html')))),
            tabPanel ('Objects and the data.frame',
              tabsetPanel (id='S2tab', type='pills',
                tabPanel ('Vectors and Matrices',
                  includeHTML('/srv/shiny-server/RSessions/RSessions/Session2/Session2a.html'),
                  htmlOutput('txtS2a'),
                ...
                tabPanel ('The data.frame',
                  includeHTML('/srv/shiny-server/RSessions/RSessions/Session2/Session2b.html')),
                tabPanel ('Addressing and Subsetting data.frames',
                  includeHTML('/srv/shiny-server/RSessions/RSessions/Session2/Session2c1.html'),
                  ...
                  htmlOutput ('txtS2c1'),
                  includeHTML('/srv/shiny-server/RSessions/RSessions/Session2/Session2c2.html'),
                  actionButton ('XS2a', label='See an answer')
                ),
                tabPanel ('Some Basic Operations',
                  includeHTML ('/srv/shiny-server/RSessions/RSessions/Session2/Session2d.html')))),
            tabPanel ('Basics',
